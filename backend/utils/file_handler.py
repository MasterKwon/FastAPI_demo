...
UPLOAD_DIRS: Dict[FileType, str] = {
    FileType.IMAGE: "backend/upload/images",
    FileType.DOCUMENT: "backend/upload/documents",
    FileType.ARCHIVE: "backend/upload/archives",
    FileType.OTHER: "backend/upload/others"
}
